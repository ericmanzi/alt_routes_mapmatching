-- Get all validated stops except Deliver cargo, Pick up cargo, Start/end my shift change driver
...
from stops s
	...
	-- and ans.help_text!='Deliver cargo' and ans.help_text!='Pick up cargo' and ans.help_text!='Start/end my shift, change driver';